...
<footer class="relative border-t border-white/10 bg-slate-950/80 backdrop-blur-2xl">
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div class="space-y-6">
                <a href="{{ route('public.homepage') }}" class="flex items-center gap-3 text-white cursor-pointer">
                ...
                <div class="flex items-center gap-4">
                    <a href="https://www.linkedin.com" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-slate-300 transition hover:border-sky-400/60 hover:text-white cursor-pointer">
                    ...
                    <a href="https://twitter.com" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-slate-300 transition hover:border-sky-400/60 hover:text-white cursor-pointer">
                    ...
                    <a href="https://instagram.com" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-slate-300 transition hover:border-sky-400/60 hover:text-white cursor-pointer">
            ...
            <div class="grid grid-cols-2 gap-8 text-sm text-slate-300 sm:grid-cols-3">
                <div class="space-y-4">
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('public.bootcamps') }}" class="transition hover:text-white cursor-pointer">Full-stack Catalyst</a></li>
                        <li><a href="{{ route('public.bootcamps') }}" class="transition hover:text-white cursor-pointer">Product Design Lab</a></li>
                        <li><a href="{{ route('public.bootcamps') }}" class="transition hover:text-white cursor-pointer">Data &amp; AI Sprint</a></li>
                        <li><a href="{{ route('public.bootcamps') }}" class="transition hover:text-white cursor-pointer">DevOps Velocity</a></li>
                    </ul>
                </div>
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold uppercase tracking-[0.28em] text-slate-400">Resources</h4>
                    <ul class="space-y-3">
                        <li><a href="{{ route('public.about') }}" class="transition hover:text-white cursor-pointer">About {{ $brandName }}</a></li>
                        <li><a href="{{ route('public.contact') }}" class="transition hover:text-white cursor-pointer">Admissions team</a></li>
                        <li><a href="#" class="transition hover:text-white cursor-pointer">Scholarships</a></li>
                        <li><a href="#" class="transition hover:text-white cursor-pointer">Corporate training</a></li>
                    </ul>
                </div>
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold uppercase tracking-[0.28em] text-slate-400">Company</h4>
                    <ul class="space-y-3">
                        <li><a href="#" class="transition hover:text-white cursor-pointer">Privacy policy</a></li>
                        <li><a href="#" class="transition hover:text-white cursor-pointer">Terms of service</a></li>
                        <li><a href="#" class="transition hover:text-white cursor-pointer">Partner with us</a></li>
                        <li><a href="#" class="transition hover:text-white cursor-pointer">Alumni stories</a></li>
                    </ul>
                </div>
            </div>
        </div>
