<div class="rounded-md p-4 mb-4 {{ $type === 'success' ? 'bg-green-50 border border-green-200' : ($type === 'error' ? 'bg-red-50 border border-red-200' : ($type === 'warning' ? 'bg-yellow-50 border border-yellow-200' : 'bg-blue-50 border border-blue-200')) }}">
    <div class="flex">
