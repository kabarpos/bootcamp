            ...
            <div class="backdrop-blur-sm bg-white/10 rounded-lg p-8">
                ...
                <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                    <div class="inline-flex rounded-md shadow">
                        <a href="{{ route('public.bootcamps') }}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-primary bg-white hover:bg-gray-50 cursor-pointer backdrop-blur-sm bg-white/90">
                            View Bootcamps
                        </a>
                    </div>
