    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                @foreach($bootcamps as $bootcamp)
                    <x-public.bootcamp-card 
                        image="https://images.unsplash.com/photo-{{ rand(1, 6) }}?auto=format&fit=crop&w=1350&q=80"
                        alt="{{ $bootcamp->title }}"
        ...
        @else
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                @for($i = 0; $i < 6; $i++)
                    <x-public.bootcamp-card 
                        image="https://images.unsplash.com/photo-{{ $i == 0 ? '1555066931-4365d14bab8c' : ($i == 1 ? '1550439062-609e1531270e' : ($i == 2 ? '1558369979-7a0e95b4e2d9' : ($i == 3 ? '1547658719-da2b51169166' : ($i == 4 ? '1551650975-87deedd944c3' : '1553877522-43269d4ea984')))) }}?auto=format&fit=crop&w=1350&q=80"
