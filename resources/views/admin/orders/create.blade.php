...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-xl font-semibold text-gray-900">Tambah Order</h1>
            <p class="mt-2 text-sm text-gray-700">Buat order baru untuk enrollment.</p>
        </div>
    </div>
        ...
        <div class="px-4 py-5 sm:p-6">
            <form action="{{ route('admin.orders.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        <label for="voucher_id" class="block text-sm font-medium text-gray-700">Voucher (Opsional)</label>
                    ...
                    <div>
                        <label for="expired_at" class="block text-sm font-medium text-gray-700">Expired At (Opsional)</label>
