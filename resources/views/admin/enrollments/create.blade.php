...
<div class="px-6 py-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Tambah Enrollment</h1>
            <p class="text-gray-600">Daftarkan user ke batch bootcamp.</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Formulir Enrollment Baru</h2>
        </div>
        <div class="p-6">
            <form action="{{ route('admin.enrollments.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="referral_id" class="block text-sm font-medium text-gray-700 mb-1">Referral (Opsional)</label>
